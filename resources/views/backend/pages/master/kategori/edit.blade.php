...
<div class="d-sm-flex align-items-center justify-content-start mb-4">
    ...
    <h1 class="h3 mb-0 text-gray-800">Edit Kategori <b>{{ $item->name }}</b></h1>
</div>
...
<div class="card shadow">
	<div class="card-body">
			...
			@endif
		<form action="{{ route('master.kategori.update', $item->id) }}" method="post" enctype="multipart/form-data">
		@csrf
		@method('PUT')
		...
		<div class="form-group">
			...
			<input  type="text"
					...
					value="{{old('kode_kategori') ?? $item->kode_kategori }}">
			@error('kode_kategori')
		...
		<div class="form-group">
			...
			<input  type="text"
					...
					value="{{old('kategori_barang') ?? $item->kategori_barang }}">
