...
<div class="d-sm-flex align-items-center justify-content-start mb-4">
	<a href="{{ route('trx.stock-in.index') }}" class="btn btn-secondary btn-circle mr-3">
		<i class="fas fa-arrow-left"></i>
	</a>
    <h1 class="h3 mb-0 text-gray-800"><b>Barang Masuk (Stock In) Detail</b></h1>
</div>
				...
				<tbody>
					...
					<tr>
						...
						<td align="right">
							...
							<form action="{{ route('trx.stock-in-detail.destroy', $detail->id) }}" method="post" class="d-inline">
							@csrf
							@method('DELETE')
								<button type="submit"
...
<div class="modal fade" id="modalAddProfessionalTeam" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<form action="{{ route('trx.stock-in-detail.store') }}" method="POST" enctype="multipart/form-data">
			@csrf
			@method('POST')
			...
			<div class="modal-body">
				<div class="row">
					<div class="form-group col-md-6">
						<input type="hidden" name="stock_in_id" value="{{ $item->id }}">
