...
<body>
    <center>
        <u><h1  style="margin-top:20px;">Akumulasi Barang Masuk</h1></u>
    </center>
    {{-- Detail --}}
    <table width="90%">
        <thead>
        ...
        <tbody>
            ...
            <tr>
                        ...
                        <td>{{ ($item->stock - $item->jumlah_masuk) }}</td>
                        <td>{{ $item->unit_satuan }}</td>
                    </tr>
                {{$no++}}
                {{$total_stock+= $item->stock }}
                {{$total_jumlah+= $item->jumlah_masuk }}
                {{$total_sisa+= ($item->stock - $item->jumlah_masuk) }}
